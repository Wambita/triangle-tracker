...
2. For a triangle to be called a triangle the sum of two sides of the triangle MUST NOT be less than or equal to the third.
3.For the triangle to be called " Equilateral" all sides have to be equal
4.For the triangle to be called "Isoceles" any two sides have to be equal
5.For the triangel to be called "scalene", No side has to be equal and the sum of two sides must be greater than the third.
